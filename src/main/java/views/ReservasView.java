		...
		txtFechaSalida.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				...
				if(txtFechaSalida.getDate()!=null && txtFechaEntrada.getDate()!=null) {
					LocalDate fechaEntrada = txtFechaEntrada.getDate().toInstant()
							.atZone(ZoneId.systemDefault())
							.toLocalDate();
					LocalDate fechaSalida = txtFechaSalida.getDate().toInstant()
							.atZone(ZoneId.systemDefault())
							.toLocalDate();
		...
		btnsiguiente.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (ReservasView.txtFechaEntrada.getDate() != null && ReservasView.txtFechaSalida.getDate() != null) {
					System.out.println("REGISTRAR RESERVA ACA"); //Puedo mandar la reserva por parametro al registro huesped
					LocalDate fechaEntrada = txtFechaEntrada.getDate().toInstant()
							.atZone(ZoneId.systemDefault())
							.toLocalDate();
					LocalDate fechaSalida = txtFechaSalida.getDate().toInstant()
					...
					if(txtFormaPago.getSelectedItem().equals("Tarjeta de Crédito")){
						formaDePago= FormaDePago.CREDITO;
					}
					if(txtFormaPago.getSelectedItem().equals("Tarjeta de Débito")){
						formaDePago= FormaDePago.DEBITO;
					}
					if(txtFormaPago.getSelectedItem().equals("Dinero en efectivo")){
